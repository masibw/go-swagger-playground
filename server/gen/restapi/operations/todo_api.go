...
func NewTodoAPI(spec *loads.Document) *TodoAPI {
	return &TodoAPI{
		...
		PatchUsersUserIDHandler: PatchUsersUserIDHandlerFunc(func(params PatchUsersUserIDParams) middleware.Responder {
...
func (o *TodoAPI) initHandlerCache() {
	...
	o.handlers["PATCH"]["/users/{userId}"] = NewPatchUsersUserID(o.context, o.PatchUsersUserIDHandler)
