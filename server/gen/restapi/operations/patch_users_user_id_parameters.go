...
//
// swagger:parameters patch-users-userId
...
//
// To ensure default values, the struct must have been initialized with NewPatchUsersUserIDParams() beforehand.
